...
const Contact = () => {
  return (
    <section id="contact-section" className="py-20 bg-black text-white" data-aos="fade-up">
      <div className="max-w-7xl mx-auto px-4 md:px-8 rounded-2xl border border-red-600/40 bg-[#141414] py-16">
        <div className="flex flex-col md:flex-row gap-12 items-center md:items-start">
          ...
          {/* Right: Contact Form */}
          <form className="flex-1 w-full" data-aos="fade-left" data-aos-delay="400" onSubmit={e => e.preventDefault()}>
